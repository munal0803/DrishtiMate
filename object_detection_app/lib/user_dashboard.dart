...
class _ObjectDetectScreenState extends State<ObjectDetectScreen> {
  ...
  final String flaskUrl = "http://10.221.208.147:5000/start_detection";
  final String callbackUrl = "http://10.221.208.147:5000/found";
        ...
        await speech.listen(
          ...
          onResult: (val) async {
            ...
            if (said.contains("help")) {
              ...
              await http.post(
                Uri.parse("http://10.97.90.147:5000/help_alert"),
                headers: {"Content-Type": "application/json"},
